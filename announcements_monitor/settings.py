...
# Scrapy settings for announcements_monitor project
#
...
BOT_NAME = 'announcements_monitor'

SPIDER_MODULES = ['announcements_monitor.spiders']
NEWSPIDER_MODULE = 'announcements_monitor.spiders'
...
ITEM_PIPELINES = {
    'announcements_monitor.pipelines.AnnouncementsMonitorPipeline': 300,#保存到mysql数据库
    #'webCrawler_scrapy.pipelines.JsonWithEncodingPipeline': 300,#保存到文件中
}

# 一次运行所有爬虫
COMMANDS_MODULE = 'announcements_monitor.commands'
...
#SPIDER_MIDDLEWARES = {
#    'announcements_monitor.middlewares.AnnouncementsMonitorSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See http://scrapy.readthedocs.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'announcements_monitor.middlewares.MyCustomDownloaderMiddleware': 543,
#}
...
#ITEM_PIPELINES = {
#    'announcements_monitor.pipelines.AnnouncementsMonitorPipeline': 300,
#}
